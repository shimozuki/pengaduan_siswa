        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <button class="btn btn-primary " href="#" role="button" data-target="#addModal" data-toggle="modal">
                        Tambah Pengaduan
                    </button>
                </div>
            </div>
                ...
                <table class="table hover data-tables nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ url('storage/images/' . $m->foto) }}" alt="" class="mb-30 text-center" height="100px" width="100px" style="  border: 5px solid #555;">
                            </td>
                            <td>{{ $m->isi_laporan }}</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list" style="">
                                        <a href="#" data-toggle="modal" style="margin-right: 10px" class="dropdown-item" data-target="#viewModal{{ $m->id_pengaduan }}" type="button">
                                            <i class="dw dw-eye"></i>View
                                        </a>
                                        <a data-toggle="modal" class="dropdown-item" data-target="#tanggapanModal{{ $m->id_pengaduan }}"><i class="icon-copy fa fa-comment" aria-hidden="true"></i>Lihat
                                            Tanggapan</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <div class="modal fade bs-example-modal-lg" id="viewModal{{ $m->id_pengaduan }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center font-18">
                                        <img src="{{ url('storage/images/' . $m->foto) }}" alt="" class="mb-30 text-center" height="200px" width="400px" style="  border: 5px solid #555;">
                        ...
                        {{-- Modal Tanggapan --}}
                        <div class="modal fade bs-example-modal-lg" id="tanggapanModal{{ $m->id_pengaduan }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myLargeModalLabel">
        ...
        <div class="modal fade bs-example-modal-lg" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/home/masyarakat/pengaduan" enctype="multipart/form-data" onsubmit="return validateForm()">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">Judul Laporan</label>
                                <div class="col-sm-12 col-md-8">
                                    <select class="form-control" aria-label="Default select example" name="judul_laporan">
                                        <option selected>Janis Pengaduan</option>
                                        <option value="Keuangan Bermasalah">Keuangan</option>
                                        <option value="Kekerasan Dalam Sekolah">Kekerasan</option>
                                        <option value="Pelecehan Sexsual terhadap murid">Pelecehan Sexual</option>
                                        <option value="Kinerja Guru dalam mengajar">Kinerja Guru</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-md-4 col-form-label">Asal Sekolah</label>
                                <div class="col-sm-12 col-md-8">
                                    <input class="form-control" type="text" name="sekolah" required minlength="10" maxlength="40">
                                    <div class="text-danger" style="visibility: hidden" id="judul_error">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    ...
                                    <input class="form-control" type="file" id="formFile" name="foto" accept=".jpg, .png" required>
